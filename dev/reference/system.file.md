...
with
[`load_all()`](https://pkgload.r-lib.org/dev/reference/load_all.md), and
if so, it uses a customized method of searching for the file. This is
necessary because the directory structure of a source package is
