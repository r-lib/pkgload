...
- [`help`](https://pkgload.r-lib.org/dev/reference/help.md)
  [`shim_help`](https://pkgload.r-lib.org/dev/reference/help.md)
  [`?`](https://pkgload.r-lib.org/dev/reference/help.md)
  [`shim_question`](https://pkgload.r-lib.org/dev/reference/help.md) :
  Drop-in replacements for help and ? functions
- [`inst()`](https://pkgload.r-lib.org/dev/reference/inst.md) : Get the
  installation path of a package
...
- [`load_dll()`](https://pkgload.r-lib.org/dev/reference/load_dll.md) :
  Load a compiled DLL
- [`package_file()`](https://pkgload.r-lib.org/dev/reference/package_file.md)
  : Find file in a package.
- [`pkg_path()`](https://pkgload.r-lib.org/dev/reference/packages.md)
  [`pkg_name()`](https://pkgload.r-lib.org/dev/reference/packages.md)
  [`pkg_desc()`](https://pkgload.r-lib.org/dev/reference/packages.md)
  [`pkg_version()`](https://pkgload.r-lib.org/dev/reference/packages.md)
  [`pkg_version_raw()`](https://pkgload.r-lib.org/dev/reference/packages.md)
  [`pkg_ns()`](https://pkgload.r-lib.org/dev/reference/packages.md) :
  Helper functions for working with development packages.
- [`shim_system.file()`](https://pkgload.r-lib.org/dev/reference/system.file.md)
  : Replacement version of system.file
- [`unload()`](https://pkgload.r-lib.org/dev/reference/unload.md)
  [`unregister()`](https://pkgload.r-lib.org/dev/reference/unload.md) :
  Unload a package
